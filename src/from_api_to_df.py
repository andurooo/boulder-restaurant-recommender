...
class Restaurants(object):
    ...
    def __init__(self):
        # set url's as attributes
        self.categories_url = 'https://api.foursquare.com/v2/venues/categories'
        self.explore_url = 'https://api.foursquare.com/v2/venues/explore'
        self.details_url_first_part = 'https://api.foursquare.com/v2/venues/'
...
# Identify all of the categories under 'Food'
        ...
        cat_response = requests.get(url=self.categories_url, params=cat_params)
        self.categories_data = json.loads(cat_response.text)

    # Define get_categories function that lists out all of the 'Food' categories/sub-categories.
...
# Identify all of the unique id's for the categories under 'Food'
    ...
    def parse_category_for_id(self, response_data):
        lst = [] 
    #     count = 0
    ...
    def explore_restaurants_by_category(self, category):
        explore_params = dict(client_id='1XEI0U5U5KWBJXEPY0AQ1BUF13LI45ZQJCVDLABHBPHM0UQ4',
        client_secret='CSLQSKDEGCNR3NN4LDBOR0C2EBKMPJK2ODICS0VJZOQEHONA',
        v='20190510',
        ll='33.7490,-84.3880',  
        query=category,
        limit=120)
    ...
    def get_all_restaurant_details(unique_ids):
        ...
        details_params = dict(client_id='1XEI0U5U5KWBJXEPY0AQ1BUF13LI45ZQJCVDLABHBPHM0UQ4',
        client_secret='CSLQSKDEGCNR3NN4LDBOR0C2EBKMPJK2ODICS0VJZOQEHONA',
            v='20190510',
            ll='33.7490,-84.3880',  
            section='food',
